...
def generate_rsa_codeT_canonical_results(num_programs, num_tests, num_input_tests, num_ransac_samples, num_out_programs, programs_dir, \
                                         canonical_programs_dir, tests_dir, const_matrix_dir, canonical_const_matrix_dir, res_programs_dir, res_json_dir):
...
if __name__ == '__main__':
    ...
    # RES_PROGRAMS_DIR="/home/rrsood/CodeGen/test_program_rsa_codet.jsonl"
    # RES_JSON_DIR="/home/rrsood/CodeGen/test_res_rsa_codet.json"

    # generate_rsa_codeT_canonical_results(NUM_PROGRAMS, NUM_TESTS, NUM_INPUT_TESTS, NUM_RANSAC_SAMPLES, NUM_OUT_PROGRAMS, \
    ...
    #         RES_PROGRAMS_DIR="/home/rrsood/CodeGen/new-data/codellama-13b/rsa_codeT_results/rsa_codeT/%d_test/codellama_humaneval_rsa_codeT_programs_%dtest_run%d.jsonl" % (num_tests, num_tests, i)
    #         RES_JSON_DIR="/home/rrsood/CodeGen/new-data/codellama-13b/rsa_codeT_results/rsa_codeT/%d_test/codellama_humaneval_rsa_codeT_result_%dtest_run%d.json" % (num_tests, num_tests, i)
    #         generate_rsa_codeT_canonical_results(NUM_PROGRAMS, NUM_TESTS, num_tests, NUM_RANSAC_SAMPLES, NUM_OUT_PROGRAMS, \
    #                                         PROGRAMS_DIR, CANONICAL_PROGRAMS_DIR, TESTS_DIR, CONST_MATRIX_DIR, CANONICAL_CONST_MATRIX_DIR, RES_PROGRAMS_DIR, RES_JSON_DIR)