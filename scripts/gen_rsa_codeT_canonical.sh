...
for n_reps in 1 2 3; 
do
    for n_inp_tests in 1 2 3 4;
    do
        res_programs_dir="/home/rrsood/CodeGen/new-data/codellama-13b/rsa_codeT_results/rsa_codeT/${n_inp_tests}_test/codellama_humaneval_rsa_codeT_programs_${n_inp_tests}test_run${n_reps}.jsonl"
        res_json_dir="/home/rrsood/CodeGen/new-data/codellama-13b/rsa_codeT_results/rsa_codeT/${n_inp_tests}_test/codellama_humaneval_rsa_codeT_result_${n_inp_tests}test_run${n_reps}.json"
