#!/bin/bash
#SBATCH --job-name=gen_rsa_codeT_canonical5
#SBATCH --output=gen_rsa_codeT_canonical5.out
#SBATCH --error=gen_rsa_codeT_canonical5.err
#SBATCH --mem=128G
#SBATCH --time=8:00:00
...
for n_reps in 1; 
do
    for n_inp_tests in 75 100;
    do
        res_programs_dir="/home/rrsood/CodeGen/prelim-results/mbpp/codellama-13b/rsa_codeT/${n_inp_tests}_test/codellama_mbpp_rsa_codeT_programs_${n_inp_tests}test_run${n_reps}.jsonl"
        res_json_dir="/home/rrsood/CodeGen/prelim-results/mbpp/codellama-13b/rsa_codeT/${n_inp_tests}_test/codellama_mbpp_rsa_codeT_result_${n_inp_tests}test_run${n_reps}.json"
